...
import { Check, Headless, Standard, Ultimate } from "../utils/imgImport"
...
const Pricing = () => {
  return (
    <section className="pricing container">
      ...
      <div className="row">
        <div className="col-sm-4 mb-3 d-flex align-items-center">
          <div className="pricing-box">
            ...
            <button className="btn-secondary w-100 my-5">
              Choose Headless
            </button>
        ...
        <div className="col-sm-4 mb-3 d-flex align-items-center">
          <div className="pricing-box active">
            ...
            <button className="btn-primary w-100 my-5">Choose Standard</button>
            <ul className="pricing-details">
              <li className="d-flex align-items-center">
                <img src={Check} alt="check" />
                Cost-savings and efficiencies
